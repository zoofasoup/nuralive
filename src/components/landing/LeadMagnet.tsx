        ...
        {state === "done" ? (
          ...
          >
            ...
            <button
              ...
              className="rounded-full bg-gradient-to-r from-honey to-honey-deep px-7 py-3.5 text-sm font-bold text-white transition hover:from-honey-deep hover:to-honey-deep disabled:opacity-60"
            >
