...
import { PACKAGES, waLink, formatRupiah } from "@/lib/config";

// Harga dihitung dari config, bukan diketik ulang - supaya tidak pernah
// diam-diam beda dari Pricing section begitu harga marketplace berubah.
const CHEAPEST_PRICE = Math.min(...PACKAGES.map((p) => p.price));
  ...
  return (
    <>
      <a
        ...
        className="fixed right-4 bottom-20 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-2xl shadow-lg transition hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-forest-deep sm:bottom-6"
      >
